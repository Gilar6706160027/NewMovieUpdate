package com.example.movieupdate.ui.main.views.upcoming.adapter
...
import com.example.movieupdate.network.LANGUAGE
...
class UpcomingAdapter(
...
) : ListAdapter<Movie, UpcomingAdapter.UpcomingViewHolder>(UserDiffCallBack()) {
    ...
    override fun onBindViewHolder(
        viewHolder: UpcomingAdapter.UpcomingViewHolder,
        position: Int
    ) {
